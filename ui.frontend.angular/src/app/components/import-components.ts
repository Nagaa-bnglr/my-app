 ...
 */
MapTo('myproject/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('myproject/components/separator')(SeparatorV1Component);

MapTo('myproject/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('myproject/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('myproject/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('myproject/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('myproject/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('myproject/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('myproject/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('myproject/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('myproject/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('myproject/components/accordion')(AccordionV1Component);
MapTo('myproject/components/tabs')(TabsV1Component);
...
LazyMapTo('myproject/components/teaser')(TeaserV1Component);
...
LazyMapTo('myproject/components/carousel')(CarouselV1Component);
...
LazyMapTo('myproject/components/text')(LazyTextModule, TextEditConfig);